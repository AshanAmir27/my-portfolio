...
export default function HeroSection() {
    ...
    return (
        <section className="relative flex items-center justify-center min-h-screen px-6 sm:px-20 py-24 bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-black dark:via-gray-900 dark:to-gray-950 font-sans overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl flex flex-col-reverse sm:flex-row items-center justify-between gap-16 text-center sm:text-left">
                ...
                >
                    ...
                    <div className="mt-10 flex gap-6 justify-center sm:justify-start flex-wrap">
                        ...
                        <a
                            href="#contact"
                            className="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                        >
                            Contact Me
                        </a>
                    </div>
            ...
            <motion.div
                className="absolute bottom-10 left-1/2 -translate-x-1/2 text-gray-700 dark:text-gray-300 opacity-60"
